...
function verasidad(dato){
  if (dato){
    console.log("es tryly");
  }else{console.log("es falsy");}
}console.log (verasidad(0));
...
function colors(color) {
  ...
  function colors(color) {
    ...
    }console.log(operadoresLogicos(10,2,11));
